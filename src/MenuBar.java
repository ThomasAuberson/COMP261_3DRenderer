...
public class MenuBar extends JMenuBar implements ActionListener {
	...
	private int MENUS_NUMBER = 2; 			
	private JMenu[] menus = new JMenu[MENUS_NUMBER];
	
	private String title1 = "Menu", title2 = "Light Sources"; 	
	private String[] menu1 = {"Load File","***","Ambient Light Intensity","Add Light Source", "***","*check*","Enable Light Rotation","***","About"}; 
	...
	// CONSTRUCTOR		
		public MenuBar(Display display, int n) {
			this.display = display; 
			menu2 = new String[n];
			for (int i = 0; i<n; i++){
				menu2[i] = "Light Source #"+(i+1);
			}
